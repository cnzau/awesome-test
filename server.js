...
//The express.Router() acts as a mini application.
//You can call an instance of it (like we do for Express) and then define routes on that. 
//app.route is basically a shortcut to call the Express Router.
//Instead of calling express.Router(), we can call app.route and start applying our routes there.
//Using app.route() lets us define multiple actions on a single login route.
//We’ll need a GET route to show the login form and a POST route to process the login form.
app.route('/login')
